      ...
      [
        ...
        },
        {
          ...
          value: function _placeDropdown() {
            ...
            var closestOverflowParent = getClosestAncestor(
              this.dropdownEl,
              function(ancestor) {
        ...
        },
        {
          ...
          value: function _updateTooltipContent() {
            this._setTooltipContent(
              this.tooltipEl.querySelector(".tooltip-content")
            );
          },
        },
        {
...
(function($, anim) {
  ...
  var Slider = (function(_Component10) {
    ...
    function Slider(el, options) {
      ...
      _this37.activeIndex = _this37.$slides
          ...
          value: function _setupEventHandlers() {
            ...
            if (this.options.indicators) {
              this.$indicators.each(function(el) {
                el.addEventListener(
                  "click",
                  _this38._handleIndicatorClickBound
                );
              });
            }
          },
            ...
            if (this.options.indicators) {
              this.$indicators.each(function(el) {
                el.removeEventListener(
                  "click",
                  _this39._handleIndicatorClickBound
                );
              });
            }
          },
...
(function($) {
  ...
  var Chips = (function(_Component11) {
    ...
    function Chips(el, options) {
      ...
      var _this42 = _possibleConstructorReturn(
        this,
      ...
      _this42.$chips = $();
      _this42._setupInput();
      _this42.hasAutocomplete =
        Object.keys(_this42.options.autocompleteOptions).length > 0;
...
(function($) {
  ...
  var Pushpin = (function(_Component12) {
    ...
    function Pushpin(el, options) {
      ...
      var _this44 = _possibleConstructorReturn(
        this,
...
(function($, anim) {
  ...
  var FloatingActionButton = (function(_Component13) {
    ...
    function FloatingActionButton(el, options) {
      ...
      _this45.$floatingBtnsReverse = _this45.$el
          ...
          value: function _animateInToolbar() {
            ...
            setTimeout(function() {
              ...
              setTimeout(function() {
                ...
                // Scroll to close.
                _this48._handleDocumentClickBound = _this48._handleDocumentClick.bind(
                  _this48
                );
                window.addEventListener(
                  "scroll",
                  _this48._handleCloseBound,
                  true
                );
                document.body.addEventListener(
                  "click",
                  _this48._handleDocumentClickBound,
                  true
                );
              }, 100);
            }, 0);
...
(function($) {
  ...
  var Datepicker = (function(_Component14) {
    ...
    function Datepicker(el, options) {
      ...
      var _this50 = _possibleConstructorReturn(
        this,
          ...
          value: function _insertHTMLIntoDOM() {
            ...
            if (this.options.container) {
              ...
              this.options.container =
                optEl instanceof HTMLElement
                  ? optEl
                  : document.querySelector(optEl);
        ...
        },
        {
          ...
          value: function _setupVariables() {
            ...
            this.formats = {
              ...
              ddd: function() {
                return _this53.options.i18n.weekdaysShort[
                  _this53.date.getDay()
                ];
              },
              dddd: function() {
              ...
              mmm: function() {
                return _this53.options.i18n.monthsShort[
                  _this53.date.getMonth()
                ];
              },
              mmmm: function() {
...
(function($) {
  ...
  var Timepicker = (function(_Component15) {
    ...
    function Timepicker(el, options) {
      ...
      var _this54 = _possibleConstructorReturn(
        this,
...
(function($) {
  ...
  var CharacterCounter = (function(_Component16) {
    ...
    function CharacterCounter(el, options) {
      ...
      var _this58 = _possibleConstructorReturn(
        this,
        (
...
(function($) {
  ...
  var Carousel = (function(_Component17) {
    ...
    function Carousel(el, options) {
      ...
      var _this59 = _possibleConstructorReturn(
        this,
      ...
      _this59.showIndicators =
        _this59.options.indicators && _this59.hasMultipleSlides;
      ...
      _this59.images = [];
      _this59.itemWidth = _this59.$el
        .find(".carousel-item")
        .first()
        .innerWidth();
      _this59.itemHeight = _this59.$el
        .find(".carousel-item")
        .first()
        .innerHeight();
      ...
      _this59.options.numVisible = Math.min(
        _this59.count,
        _this59.options.numVisible
      );
          ...
          value: function _setupEventHandlers() {
            ...
            if (this.showIndicators && this.$indicators) {
              ...
              this.$indicators.find(".indicator-item").each(function(el, i) {
                el.addEventListener(
                  "click",
                  _this60._handleIndicatorClickBound
                );
              });
            }
          ...
          value: function _removeEventHandlers() {
            ...
            if (this.showIndicators && this.$indicators) {
              this.$indicators.find(".indicator-item").each(function(el, i) {
                el.removeEventListener(
                  "click",
                  _this61._handleIndicatorClickBound
                );
              });
            }
...
(function($) {
  ...
  var TapTarget = (function(_Component18) {
    ...
    function TapTarget(el, options) {
      ...
      var _this64 = _possibleConstructorReturn(
        this,
...
(function($) {
  ...
  var FormSelect = (function(_Component19) {
    ...
    function FormSelect(el, options) {
      ...
      var _this65 = _possibleConstructorReturn(
        this,
      ...
      [
          ...
          value: function _removeEventHandlers() {
            ...
            $(this.dropdownOptions)
              ...
              .each(function(el) {
                el.removeEventListener(
                  "click",
                  _this67._handleOptionClickBound
                );
              });
            this.el.removeEventListener(
              "change",
          ...
          value: function _setupDropdown() {
              ...
              this.$selectOptions.each(function(el) {
                if ($(el).is("option")) {
                  ...
                  if (_this68.isMultiple) {
                    optionEl = _this68._appendOptionWithIcon(
                      _this68.$el,
                      el,
                      "multiple"
                    );
                  ...
                  $(_this68.dropdownOptions).append(
                    $(
                  ...
                  selectOptions.each(function(el) {
                    var optionEl = _this68._appendOptionWithIcon(
                      _this68.$el,
                      el,
                      "optgroup-option"
                    );
            ...
            if (!this.el.disabled) {
              ...
              dropdownOptions.onOpenEnd = function(el) {
                var selectedOption = $(_this68.dropdownOptions)
                  .find(".selected")
                  .first();
                ...
                if (selectedOption.length) {
                  ...
                  if (_this68.dropdown.isScrollable) {
                    var scrollOffset =
                      ...
                      _this68.dropdownOptions.getBoundingClientRect().top; // scroll to selected option
        ...
        },
        {
          ...
          value: function _appendOptionWithIcon(select, option, type) {
            ...
            if (!!iconUrl) {
              var imgEl = $(
                '<img alt="" class="' + classes + '" src="' + iconUrl + '">'
              );
              liEl.prepend(imgEl);
            }
